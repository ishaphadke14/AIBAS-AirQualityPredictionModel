...
def plot_training_curves(history):
    ...
    plt.savefig('../../documentation/ai_training_curves.png', dpi=300)
    plt.close()
...
def plot_diagnostic_plots(y_test, y_pred):
    ...
    plt.tight_layout()
    plt.savefig('../../documentation/ai_diagnostic_plots.png', dpi=300)
    plt.close()
...
def plot_scatter_with_regression(y_test, y_pred):
    ...
    plt.savefig('../../documentation/ai_scatter_regression.png', dpi=300)
    plt.close()
